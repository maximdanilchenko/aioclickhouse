...
from aioclickhouse.constants import CompressionMethod, CompressionMethodByte
from aioclickhouse.reader import read_binary_uint32
from aioclickhouse.writer import write_binary_uint32, write_binary_uint8
...
class Decompressor(BaseDecompressor):
    ...
    async def get_decompressed_data(self, method_byte, compressed_hash, extra_header_size):
        size_with_header = await read_binary_uint32(self.stream)
        ...
        uncompressed_size = await read_binary_uint32(compressed)
